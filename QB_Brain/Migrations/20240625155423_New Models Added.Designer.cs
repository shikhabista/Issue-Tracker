...
namespace IT_Web.Migrations
{
    ...
    [Migration("20240625155423_New Models Added")]
            ...
            modelBuilder.Entity("Base.Entities.Issue", b =>
                {
                    ...
                    b.HasIndex("RecById")
                        .HasDatabaseName("ix_issue_rec_by_id");
            ...
            modelBuilder.Entity("Base.Entities.IssueLabel", b =>
                {
                    ...
                    b.HasIndex("RecById")
                        .HasDatabaseName("ix_issue_label_rec_by_id");
            ...
            modelBuilder.Entity("Base.Entities.Label", b =>
                {
                    ...
                    b.HasIndex("RecById")
                        .HasDatabaseName("ix_label_rec_by_id");
            ...
            modelBuilder.Entity("Base.Entities.Issue", b =>
                {
                    ...
                    b.HasOne("Base.Entities.User", "RecBy")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_issue_user_rec_by_id");
            ...
            modelBuilder.Entity("Base.Entities.IssueLabel", b =>
                {
                    ...
                    b.HasOne("Base.Entities.User", "RecBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_issue_label_user_rec_by_id");
            ...
            modelBuilder.Entity("Base.Entities.Label", b =>
                {
                    b.HasOne("Base.Entities.User", "RecBy")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_label_user_rec_by_id");
